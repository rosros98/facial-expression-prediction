...
for general_csv_dist_path in glob.iglob('Dataset CK+/Train&Test/ALL_LocalDistances/**/20/*.csv'):
...
# Scorro tutte le cartelle contenenti le distanze locali
for general_csv_dist_path in glob.iglob('Dataset CK+/Train&Test/ALL_LocalDistances/**/20/*.csv'):
...
with open('../Dataset CK+/Train&Test/ALL_LocalDistances/dataset_local_distances_20.csv', 'w', newline='') as f:
    write = csv.writer(f)
