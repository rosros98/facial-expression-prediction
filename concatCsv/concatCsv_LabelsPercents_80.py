...
for general_csv_dist_path in glob.iglob('../Dataset CK+/Train&Test/ALL_LabelsPercents/**/80/*.csv'):
...
with open('../Dataset CK+/Train&Test/ALL_LabelsPercents/dataset_labels_percents_80.csv', 'w', newline='') as f:
    write = csv.writer(f)
