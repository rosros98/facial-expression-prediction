...
for general_csv_dist_path in glob.iglob('../Dataset CK+/Train&Test/ALL_GlobalDistances/**/80/*.csv'):
...
with open('../Dataset CK+/Train&Test/ALL_GlobalDistances/dataset_global_distances_80.csv', 'w', newline='') as f:
    write = csv.writer(f)
