...
for super_general_csv_dist_path in glob.iglob('../Dataset CK+/Train&Test/ALL_GlobalDistances/**'):
    index_name = []
    ...
    if arr_super_general_csv_dist_path[4] == '1' or arr_super_general_csv_dist_path[4] == '2' or \
        ...
        #print("****" + arr_general_csv_dist_path[4] + "****")
        #print(df_list)

        with open(super_general_csv_dist_path + '_dataset_global_distances_20.csv', 'w', newline='') as f:
            write = csv.writer(f)
