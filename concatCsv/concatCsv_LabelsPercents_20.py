...
for general_csv_dist_path in glob.iglob('../Dataset CK+/Train&Test/ALL_LabelsPercents/**/20/*.csv'):
...
with open('../Dataset CK+/Train&Test/ALL_LabelsPercents/dataset_labels_percents_20.csv', 'w', newline='') as f:
    write = csv.writer(f)
